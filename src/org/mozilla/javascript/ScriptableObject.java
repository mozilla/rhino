                                                  ...
                                                  ConstProperties
{
    ...
    public static class Slot
        implements ScriptableObjectSlot, Serializable
    {
    ...
    /**
     * Callers who use the "getSlot" methods to directly get Slot instances and cache them
     * must check this value before using a slot to ensure that it is still
     * valid.
     */
    public boolean checkGeneration(int gen) {
        return slotMap.getGeneration() == gen;
    }

    /**
     * Callers can use this to get the current generation so that they know what to check.
     */
    public int getGeneration() {
        return slotMap.getGeneration();
    }
    ...
    /**
     * This method is used for optimizing the generated bytecode.
     * Get the Slot that holds the value. The caller who uses this
     * is responsible for comparing the value of "getGeneration"
     * and re-looking the Slot if it has increased. Furthermore,
     * this method may return null even if "has" or "get" would
     * not return null because of subclassing.
     */
    public ScriptableObjectSlot getSlot(String name)
    {
