 ...
 * @author Norris Boyd
 */
public class NativeClassyObject extends ClassyScriptable implements IdFunctionCall, Map
{
    ...
    {
        NativeClassyObject obj = new NativeClassyObject();
        ...
        if (f.hasTag(OBJECT_STATIC_TAG)) {
            ...
            switch (StaticMethods.values()[id]) {
                ...
                case create:
                {
                    ...
                    NativeClassyObject newObject = new NativeClassyObject();
    ...
    class EntrySet extends AbstractSet<Entry<Object, Object>> {
        ...
        public Iterator<Entry<Object, Object>> iterator() {
            return new Iterator<Map.Entry<Object, Object>>() {
                ...
                public void remove() {
                    ...
                    NativeClassyObject.this.remove(key);
                    key = null;
                }
            };
        }
        ...
        @Override
        public int size() {
            return NativeClassyObject.this.size();
        }
    }
