...
class JavaMembers {
    ...
    private void reflect(Scriptable scope, boolean includeProtected, boolean includePrivate) {
        ...
        if (Map.class.isAssignableFrom(cl)) {
            // Add Map iterator
            members.put(NativeIterator.ITERATOR_PROPERTY_NAME, NativeIterator.JAVA_MAP_ITERATOR);

        } else if (Iterable.class.isAssignableFrom(cl)) {
            // Add Iterable/Collection iterator
            members.put(
                    NativeIterator.ITERATOR_PROPERTY_NAME, NativeIterator.JAVA_COLLECTION_ITERATOR);
