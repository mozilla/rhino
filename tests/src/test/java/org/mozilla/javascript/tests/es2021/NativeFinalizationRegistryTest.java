...
public class NativeFinalizationRegistryTest {
    ...
    @Test
    public void finalizationRegistryCleanupSomeExists() {
        assertES6(
                "var registry = new FinalizationRegistry(function(){}); typeof registry.cleanupSome === 'function'",
                true);
    }

    @Test
    public void finalizationRegistryCleanupSomeReturnsUndefined() {
        assertES6(
                "var registry = new FinalizationRegistry(function(){}); registry.cleanupSome() === undefined",
                true);
    }

    @Test
    public void finalizationRegistryCleanupSomeWithCallback() {
        assertES6(
                "var registry = new FinalizationRegistry(function(){}); registry.cleanupSome(function(){}) === undefined",
                true);
    }

    @Test
    public void finalizationRegistryCleanupSomeWithNonFunction() {
        assertES6(
                "var registry = new FinalizationRegistry(function(){}); try { registry.cleanupSome('not a function'); false; } catch(e) { e instanceof TypeError; }",
                true);
    }
    ...
    public void finalizationRegistryRegisterWithExtraArguments() {
        assertES6(
                "var registry = new FinalizationRegistry(function(){}); var obj = {}; var token = {}; registry.register(obj, 'cleanup data', token, 'extra', 'args'); true",
                true);
    }
