...
public class BoundFunctionTest {
    ...
    public void fooArgs0_boundArgs0_callArgs0() {
        Utils.assertWithAllModes_ES6("boundThis []",
                constructCode(0, 0, ".call('callThis'", 0, false));
        Utils.assertWithAllModes_ES6("boundThis []",
                constructCode(0, 0, ".call('callThis'", 0, true));
    }

    @Test
    public void fooArgs0_boundArgs0_callArgs1() {
        Utils.assertWithAllModes_ES6("boundThis [x]",
                constructCode(0, 0, ".call('callThis'", 1, false));
        Utils.assertWithAllModes_ES6("boundThis [x]",
                constructCode(0, 0, ".call('callThis'", 1, true));
    }

    @Test
    public void fooArgs0_boundArgs0_callArgs2() {
        Utils.assertWithAllModes_ES6("boundThis [x,y]",
                constructCode(0, 0, ".call('callThis'", 2, false));
        Utils.assertWithAllModes_ES6("boundThis [x,y]",
                constructCode(0, 0, ".call('callThis'", 2, true));
    }

    @Test
    public void fooArgs0_boundArgs1_callArgs0() {
        Utils.assertWithAllModes_ES6("boundThis [a]",
                constructCode(0, 1, ".call('callThis'", 0, false));
        Utils.assertWithAllModes_ES6("boundThis [a]",
                constructCode(0, 1, ".call('callThis'", 0, true));
    }

    @Test
    public void fooArgs0_boundArgs1_callArgs1() {
        Utils.assertWithAllModes_ES6("boundThis [a,x]",
                constructCode(0, 1, ".call('callThis'", 1, false));
        Utils.assertWithAllModes_ES6("boundThis [a,x]",
                constructCode(0, 1, ".call('callThis'", 1, true));
    }

    @Test
    public void fooArgs0_boundArgs1_callArgs2() {
        Utils.assertWithAllModes_ES6("boundThis [a,x,y]",
                constructCode(0, 1, ".call('callThis'", 2, false));
        Utils.assertWithAllModes_ES6("boundThis [a,x,y]",
                constructCode(0, 1, ".call('callThis'", 2, true));
    }

    @Test
    public void fooArgs0_boundArgs2_callArgs0() {
        Utils.assertWithAllModes_ES6("boundThis [a,b]",
                constructCode(0, 2, ".call('callThis'", 0, false));
        Utils.assertWithAllModes_ES6("boundThis [a,b]",
                constructCode(0, 2, ".call('callThis'", 0, true));
    }

    @Test
    public void fooArgs0_boundArgs2_callArgs1() {
        Utils.assertWithAllModes_ES6("boundThis [a,b,x]",
                constructCode(0, 2, ".call('callThis'", 1, false));
        Utils.assertWithAllModes_ES6("boundThis [a,b,x]",
                constructCode(0, 2, ".call('callThis'", 1, true));
    }

    @Test
    public void fooArgs0_boundArgs2_callArgs2() {
        Utils.assertWithAllModes_ES6("boundThis [a,b,x,y]",
                constructCode(0, 2, ".call('callThis'", 2, false));
        Utils.assertWithAllModes_ES6("boundThis [a,b,x,y]",
                constructCode(0, 2, ".call('callThis'", 2, true));
    }

    @Test
    public void fooArgs1_boundArgs0_callArgs0() {
        Utils.assertWithAllModes_ES6("boundThis undefined []",
                constructCode(1, 0, ".call('callThis'", 0, false));
        Utils.assertWithAllModes_ES6("boundThis undefined []",
                constructCode(1, 0, ".call('callThis'", 0, true));
    }

    @Test
    public void fooArgs1_boundArgs0_callArgs1() {
        Utils.assertWithAllModes_ES6("boundThis x []",
                constructCode(1, 0, ".call('callThis'", 1, false));
        Utils.assertWithAllModes_ES6("boundThis x []",
                constructCode(1, 0, ".call('callThis'", 1, true));
    }

    @Test
    public void fooArgs1_boundArgs0_callArgs2() {
        Utils.assertWithAllModes_ES6("boundThis x [y]",
                constructCode(1, 0, ".call('callThis'", 2, false));
        Utils.assertWithAllModes_ES6("boundThis x [y]",
                constructCode(1, 0, ".call('callThis'", 2, true));
    }

    @Test
    public void fooArgs1_boundArgs1_callArgs0() {
        Utils.assertWithAllModes_ES6("boundThis a []",
                constructCode(1, 1, ".call('callThis'", 0, false));
        Utils.assertWithAllModes_ES6("boundThis a []",
                constructCode(1, 1, ".call('callThis'", 0, true));
    }

    @Test
    public void fooArgs1_boundArgs1_callArgs1() {
        Utils.assertWithAllModes_ES6("boundThis a [x]",
                constructCode(1, 1, ".call('callThis'", 1, false));
        Utils.assertWithAllModes_ES6("boundThis a [x]",
                constructCode(1, 1, ".call('callThis'", 1, true));
    }

    @Test
    public void fooArgs1_boundArgs1_callArgs2() {
        Utils.assertWithAllModes_ES6("boundThis a [x,y]",
                constructCode(1, 1, ".call('callThis'", 2, false));
        Utils.assertWithAllModes_ES6("boundThis a [x,y]",
                constructCode(1, 1, ".call('callThis'", 2, true));
    }

    @Test
    public void fooArgs1_boundArgs2_callArgs0() {
        Utils.assertWithAllModes_ES6("boundThis a [b]",
                constructCode(1, 2, ".call('callThis'", 0, false));
        Utils.assertWithAllModes_ES6("boundThis a [b]",
                constructCode(1, 2, ".call('callThis'", 0, true));
    }

    @Test
    public void fooArgs1_boundArgs2_callArgs1() {
        Utils.assertWithAllModes_ES6("boundThis a [b,x]",
                constructCode(1, 2, ".call('callThis'", 1, false));
        Utils.assertWithAllModes_ES6("boundThis a [b,x]",
                constructCode(1, 2, ".call('callThis'", 1, true));
    }

    @Test
    public void fooArgs1_boundArgs2_callArgs2() {
        Utils.assertWithAllModes_ES6("boundThis a [b,x,y]",
                constructCode(1, 2, ".call('callThis'", 2, false));
        Utils.assertWithAllModes_ES6("boundThis a [b,x,y]",
                constructCode(1, 2, ".call('callThis'", 2, true));
    }
    ...
    public void fooArgs2_boundArgs0_callArgs1() {
        Utils.assertWithAllModes_ES6("boundThis x,undefined []",
                constructCode(2, 0, ".call('callThis'", 1, false));
        Utils.assertWithAllModes_ES6("boundThis x,undefined []",
                constructCode(2, 0, ".call('callThis'", 1, true));
    }

    @Test
    public void fooArgs2_boundArgs0_callArgs2() {
        Utils.assertWithAllModes_ES6("boundThis x,y []",
                constructCode(2, 0, ".call('callThis'", 2, false));
        Utils.assertWithAllModes_ES6("boundThis x,y []",
                constructCode(2, 0, ".call('callThis'", 2, true));
    }

    @Test
    public void fooArgs2_boundArgs1_callArgs0() {
        Utils.assertWithAllModes_ES6("boundThis a,undefined []",
                constructCode(2, 1, ".call('callThis'", 0, false));
        Utils.assertWithAllModes_ES6("boundThis a,undefined []",
                constructCode(2, 1, ".call('callThis'", 0, true));
    }

    @Test
    public void fooArgs2_boundArgs1_callArgs1() {
        Utils.assertWithAllModes_ES6("boundThis a,x []",
                constructCode(2, 1, ".call('callThis'", 1, false));
        Utils.assertWithAllModes_ES6("boundThis a,x []",
                constructCode(2, 1, ".call('callThis'", 1, true));
    }

    @Test
    public void fooArgs2_boundArgs1_callArgs2() {
        Utils.assertWithAllModes_ES6("boundThis a,x [y]",
                constructCode(2, 1, ".call('callThis'", 2, false));
        Utils.assertWithAllModes_ES6("boundThis a,x [y]",
                constructCode(2, 1, ".call('callThis'", 2, true));
    }

    @Test
    public void fooArgs2_boundArgs2_callArgs0() {
        Utils.assertWithAllModes_ES6("boundThis a,b []",
                constructCode(2, 2, ".call('callThis'", 0, false));
        Utils.assertWithAllModes_ES6("boundThis a,b []",
                constructCode(2, 2, ".call('callThis'", 0, true));
    }

    @Test
    public void fooArgs2_boundArgs2_callArgs1() {
        Utils.assertWithAllModes_ES6("boundThis a,b [x]",
                constructCode(2, 2, ".call('callThis'", 1, false));
        Utils.assertWithAllModes_ES6("boundThis a,b [x]",
                constructCode(2, 2, ".call('callThis'", 1, true));
    }

    @Test
    public void fooArgs2_boundArgs2_callArgs2() {
        Utils.assertWithAllModes_ES6("boundThis a,b [x,y]",
                constructCode(2, 2, ".call('callThis'", 2, false));
        Utils.assertWithAllModes_ES6("boundThis a,b [x,y]",
                constructCode(2, 2, ".call('callThis'", 2, true));
    }
    ...
    public void fooArgs0_boundArgs0_applyArgs0() {
        Utils.assertWithAllModes_ES6("boundThis []",
                constructCode(0, 0, ".apply('applyThis'", 0, false));
        Utils.assertWithAllModes_ES6("boundThis []",
                constructCode(0, 0, ".apply('applyThis'", 0, true));
    }

    @Test
    public void fooArgs0_boundArgs0_applyArgsNull() {
        Utils.assertWithAllModes_ES6("boundThis []",
                constructCode(0, 0, ".apply('applyThis'", -1, false));
        Utils.assertWithAllModes_ES6("boundThis []",
                constructCode(0, 0, ".apply('applyThis'", -1, true));
    }

    @Test
    public void fooArgs0_boundArgs0_applyArgsEmpty() {
        Utils.assertWithAllModes_ES6("boundThis []",
                constructCode(0, 0, ".apply('applyThis'", -2, false));
        Utils.assertWithAllModes_ES6("boundThis []",
                constructCode(0, 0, ".apply('applyThis'", -2, true));
    }
    ...
    public void fooArgs0_boundArgs1_applyArgs0() {
        Utils.assertWithAllModes_ES6("boundThis [a]",
                constructCode(0, 1, ".apply('applyThis'", 0, false));
        Utils.assertWithAllModes_ES6("boundThis [a]",
                constructCode(0, 1, ".apply('applyThis'", 0, true));
    }

    @Test
    public void fooArgs0_boundArgs1_applyArgsNull() {
        Utils.assertWithAllModes_ES6("boundThis [a]",
                constructCode(0, 1, ".apply('applyThis'", -1, false));
        Utils.assertWithAllModes_ES6("boundThis [a]",
                constructCode(0, 1, ".apply('applyThis'", -1, true));
    }

    @Test
    public void fooArgs0_boundArgs1_applyArgsEmpty() {
        Utils.assertWithAllModes_ES6("boundThis [a]",
                constructCode(0, 1, ".apply('applyThis'", -2, false));
        Utils.assertWithAllModes_ES6("boundThis [a]",
                constructCode(0, 1, ".apply('applyThis'", -2, true));
    }
    ...
    public void fooArgs0_boundArgs2_applyArgs0() {
        Utils.assertWithAllModes_ES6("boundThis [a,b]",
                constructCode(0, 2, ".apply('applyThis'", 0, false));
        Utils.assertWithAllModes_ES6("boundThis [a,b]",
                constructCode(0, 2, ".apply('applyThis'", 0, true));
    }

    @Test
    public void fooArgs0_boundArgs2_applyArgsNull() {
        Utils.assertWithAllModes_ES6("boundThis [a,b]",
                constructCode(0, 2, ".apply('applyThis'", -1, false));
        Utils.assertWithAllModes_ES6("boundThis [a,b]",
                constructCode(0, 2, ".apply('applyThis'", -1, true));
    }

    @Test
    public void fooArgs0_boundArgs2_applyArgsEmpty() {
        Utils.assertWithAllModes_ES6("boundThis [a,b]",
                constructCode(0, 2, ".apply('applyThis'", -2, false));
        Utils.assertWithAllModes_ES6("boundThis [a,b]",
                constructCode(0, 2, ".apply('applyThis'", -2, true));
    }
    ...
    public void fooArgs1_boundArgs0_applyArgs0() {
        Utils.assertWithAllModes_ES6("boundThis undefined []",
                constructCode(1, 0, ".apply('applyThis'", 0, false));
        Utils.assertWithAllModes_ES6("boundThis undefined []",
                constructCode(1, 0, ".apply('applyThis'", 0, true));
    }

    @Test
    public void fooArgs1_boundArgs0_applyArgsNull() {
        Utils.assertWithAllModes_ES6("boundThis undefined []",
                constructCode(1, 0, ".apply('applyThis'", -1, false));
        Utils.assertWithAllModes_ES6("boundThis undefined []",
                constructCode(1, 0, ".apply('applyThis'", -1, true));
    }

    @Test
    public void fooArgs1_boundArgs0_applyArgsEmpty() {
        Utils.assertWithAllModes_ES6("boundThis undefined []",
                constructCode(1, 0, ".apply('applyThis'", -2, false));
        Utils.assertWithAllModes_ES6("boundThis undefined []",
                constructCode(1, 0, ".apply('applyThis'", -2, true));
    }
    ...
    public void fooArgs1_boundArgs1_applyArgs0() {
        Utils.assertWithAllModes_ES6("boundThis a []",
                constructCode(1, 1, ".apply('applyThis'", 0, false));
        Utils.assertWithAllModes_ES6("boundThis a []",
                constructCode(1, 1, ".apply('applyThis'", 0, true));
    }

    @Test
    public void fooArgs1_boundArgs1_applyArgsNull() {
        Utils.assertWithAllModes_ES6("boundThis a []",
                constructCode(1, 1, ".apply('applyThis'", -1, false));
        Utils.assertWithAllModes_ES6("boundThis a []",
                constructCode(1, 1, ".apply('applyThis'", -1, true));
    }

    @Test
    public void fooArgs1_boundArgs1_applyArgsEmpty() {
        Utils.assertWithAllModes_ES6("boundThis a []",
                constructCode(1, 1, ".apply('applyThis'", -2, false));
        Utils.assertWithAllModes_ES6("boundThis a []",
                constructCode(1, 1, ".apply('applyThis'", -2, true));
    }
    ...
    public void fooArgs1_boundArgs2_applyArgs0() {
        Utils.assertWithAllModes_ES6("boundThis a [b]",
                constructCode(1, 2, ".apply('applyThis'", 0, false));
        Utils.assertWithAllModes_ES6("boundThis a [b]",
                constructCode(1, 2, ".apply('applyThis'", 0, true));
    }

    @Test
    public void fooArgs1_boundArgs2_applyArgsNull() {
        Utils.assertWithAllModes_ES6("boundThis a [b]",
                constructCode(1, 2, ".apply('applyThis'", -1, false));
        Utils.assertWithAllModes_ES6("boundThis a [b]",
                constructCode(1, 2, ".apply('applyThis'", -1, true));
    }

    @Test
    public void fooArgs1_boundArgs2_applyArgsEmpty() {
        Utils.assertWithAllModes_ES6("boundThis a [b]",
                constructCode(1, 2, ".apply('applyThis'", -2, false));
        Utils.assertWithAllModes_ES6("boundThis a [b]",
                constructCode(1, 2, ".apply('applyThis'", -2, true));
    }
    ...
    public void fooArgs2_boundArgs1_applyArgs0() {
        Utils.assertWithAllModes_ES6("boundThis a,undefined []",
                constructCode(2, 1, ".apply('applyThis'", 0, false));
        Utils.assertWithAllModes_ES6("boundThis a,undefined []",
                constructCode(2, 1, ".apply('applyThis'", 0, true));
    }

    @Test
    public void fooArgs2_boundArgs1_applyArgsNull() {
        Utils.assertWithAllModes_ES6("boundThis a,undefined []",
                constructCode(2, 1, ".apply('applyThis'", -1, false));
        Utils.assertWithAllModes_ES6("boundThis a,undefined []",
                constructCode(2, 1, ".apply('applyThis'", -1, true));
    }

    @Test
    public void fooArgs2_boundArgs1_applyArgsEmpty() {
        Utils.assertWithAllModes_ES6("boundThis a,undefined []",
                constructCode(2, 1, ".apply('applyThis'", -2, false));
        Utils.assertWithAllModes_ES6("boundThis a,undefined []",
                constructCode(2, 1, ".apply('applyThis'", -2, true));
    }
    ...
    public void fooArgs2_boundArgs2_applyArgs0() {
        Utils.assertWithAllModes_ES6("boundThis a,b []",
                constructCode(2, 2, ".apply('applyThis'", 0, false));
        Utils.assertWithAllModes_ES6("boundThis a,b []",
                constructCode(2, 2, ".apply('applyThis'", 0, true));
    }

    @Test
    public void fooArgs2_boundArgs2_applyArgsNull() {
        Utils.assertWithAllModes_ES6("boundThis a,b []",
                constructCode(2, 2, ".apply('applyThis'", -1, false));
        Utils.assertWithAllModes_ES6("boundThis a,b []",
                constructCode(2, 2, ".apply('applyThis'", -1, true));
    }

    @Test
    public void fooArgs2_boundArgs2_applyArgsEmpty() {
        Utils.assertWithAllModes_ES6("boundThis a,b []",
                constructCode(2, 2, ".apply('applyThis'", -2, false));
        Utils.assertWithAllModes_ES6("boundThis a,b []",
                constructCode(2, 2, ".apply('applyThis'", -2, true));
    }
    ...
    public String constructCode(int fooArgs, int boundArgs, String invokeFoo, int invokeArgs, boolean activation) {
