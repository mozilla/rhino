...
public class ParserTest extends TestCase {
    ...
    public void testParseParenExpr() {
      AstRoot root = parse("x;(x);");
      AstNode parenexp = ((ExpressionStatement)
          root.getFirstChild().getNext()).getExpression();
      assertEquals(2, parenexp.getAbsolutePosition());
      assertEquals(3, parenexp.getLength());
    }
