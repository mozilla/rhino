...
import org.mozilla.javascript.GraphComparable;
...
public final class JavaAdapter implements GraphComparable {
    ...
    @Override
    public boolean graphEquals(Object o) {
        return o instanceof JavaAdapter;
    }
    ...
    /**
     * Deprecate? public static Scriptable runScript(final Script script) { return
     * ContextFactory.getGlobal() .call( cx -> { var top = ScriptRuntime.getGlobal(cx);
     * script.exec(cx, top, top.getGlobalThis()); return top.getGlobalThis(); }); }
     */
