...
public class NativeJavaTopPackage extends NativeJavaPackage
        implements Function, IdFunctionCall, GraphComparable {
    @Serial private static final long serialVersionUID = -1455787259477709999L;

    private static final String[] TOP_ANDROID_PACKAGE_NAMES =
            new String[] {"java", "javax", "org", "com", "edu", "net", "android"};
    private static final String[] TOP_PACKAGE_NAMES =
    ...
    public boolean graphEquals(Object o) {
        return o instanceof NativeJavaTopPackage;
    }
