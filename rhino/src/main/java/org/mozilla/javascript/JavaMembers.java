...
class JavaMembers {
    ...
    private void reflect(
        ...
        for (int tableCursor = 0; tableCursor != 2; ++tableCursor) {
            ...
            for (Map.Entry<String, Object> entry : ht.entrySet()) {
                ...
                if (value instanceof Method) {
                    ...
                    methodBoxes[0] = new MemberBox(scope, (Method) value, typeFactory, this.cl);
                } else {
                    ...
                    for (int i = 0; i != N; ++i) {
                        ...
                        methodBoxes[i] = new MemberBox(scope, method, typeFactory, this.cl);
                    }
                }
        ...
        for (int i = 0; i != constructors.length; ++i) {
            ctorMembers[i] = new MemberBox(scope, constructors[i], typeFactory);
        }
