...
class BodyCodegen {
    ...
    // Positions are recorded per method, so every method this body opens has to say which it is
    private void startMethod(String name, String signature, short flags) {
        currentMethodName = name;
        lastEmittedLine = -1;
        cfw.startMethod(name, signature, flags);
    }
