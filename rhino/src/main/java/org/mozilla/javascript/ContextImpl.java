...
public class ContextImpl implements Context {
     ...
     *     {@link #ContextImpl(ContextFactory)} constructor instead in the subclasses' constructors.
     */
    @Deprecated
    public ContextImpl() {
     ...
     */
    protected ContextImpl(ContextFactory factory) {
        if (factory == null) {
    ...
    static final Context enter(ContextFactory factory) {
        ...
        if (oldCx != null) {
            return new ContextNested(oldCx);
...
boolean closed = false;
     ...
     * of {@link Map Map}, {@link java.util.Collection Collection}, or {@link Object Object[]}.
     *
    ...
    private static void notifyDebugger_r(Context cx, DebuggableScript dscript, String debugSource) {
        cx.impl().debugger.handleCompilationDone(cx, dscript, debugSource);
    ...
    static String getSourcePositionFromStack(int[] linep) {
        ...
        if (cx.impl().lastInterpreterFrame != null) {
