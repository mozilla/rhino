...
class NativeScript extends BaseFunction {
    ...
    private static Object js_compile(Context cx, Scriptable scope, Object thisObj, Object[] args) {
    ...
    private static Object js_exec(Context cx, Scriptable scope, Object thisObj, Object[] args) {
