...
public class NullabilityDetectorTest {
    ...
    public void testNullableDetectorForConstructorWithSeveralArgs() {
        ...
        assertThat(memberBox.getArgNullability(), is(new boolean[] {true, false, true, false}));
    }
